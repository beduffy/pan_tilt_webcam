...
class FaceTracker(Node):
    def __init__(self):
        ...
        self.constant_linear_speed = 0.1  # Constant linear speed towards the face
    ...
    def track_face(self):
        ...
        if chosen_center_pix_pos:
            ...
            self.send_twist_command(amount_to_rotate_by, self.constant_linear_speed)
    ...
    def send_twist_command(self, amount_to_rotate_by, linear_speed):
        twist_msg = Twist()
